...
namespace ShipApplication
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            Texture2D tex = this.Content.Load<Texture2D>("Images/Ship2");
            Vector2 stage = new Vector2(graphics.PreferredBackBufferWidth, graphics.PreferredBackBufferHeight);
            Vector2 position = new Vector2(stage.X / 2, stage.Y / 2);
            Vector2 speed = new Vector2(1, 1);
            ship = new Ship(this, spriteBatch, tex, position, speed, stage);
